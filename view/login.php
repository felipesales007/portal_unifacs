						...
						<div class="row wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">
							<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
								<div class="card card-signup">
									<form class="form" method="POST" action="portal.php" onsubmit="return login_valida(this)">
										<div class="header header-primary text-center">
											<img src="assets/img/portal_estudante.png" width="250">
										</div>
										...
										<div class="content">
											...
											<i id="i" class="pull-right material-icons wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".9s" data-toggle="tooltip" data-placement="top" title="Pode ser os 6 primeiros dígitos do seu CPF ou senha modificada no Portal do Estudante.">error_outline</i>
											<div class="input-group wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".9s">
												<span class="input-group-addon">
													<i class="material-icons">lock_outline</i>
												</span>												
												<input required class="form-control" type="password" name="login_senha" tabindex="2" placeholder="Senha">												
											</div>
										</div>
										<div class="footer text-center wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.2s">
											<button id="enter" class="btn btn-simple btn-primary btn-lg" type="submit" tabindex="3"><i id="carregando"></i>Entrar</button>
										</div>
										<a href="recuperar_senha.php" class="pull-right" id="esqueceu">Esqueceu a senha?</a>	
									</form>
								</div>
							</div>
						</div>
